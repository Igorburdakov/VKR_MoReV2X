...
//TODO FIXME NEW for V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X V2X
 ...
 // PATCH 2026-05-28: configurable CBR evaluation window (replaces hard-coded
 // x in [1500, 3500] gate inherited from 3GPP highway-straight scenario).
 // Defaults are wide-open (±1e9) so any scenario (oval, urban, custom SUMO)
 // produces CBR samples. To reproduce the original behaviour use:
 //   Config::SetDefault ("ns3::NrV2XUePhy::CBRxMin", DoubleValue(1500));
 //   Config::SetDefault ("ns3::NrV2XUePhy::CBRxMax", DoubleValue(3500));
 double m_CBRxMin;
 double m_CBRxMax;
